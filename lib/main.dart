      ...
      home: Scaffold(
        ...
        body: Column(
          children: [
            ...
            InformationWedgit('اسم الطالب', 'رولين الطناني'),
          ],
        ),
      ),
    );
...
class InformationWedgit extends StatelessWidget {
  String? keyN;
  String? valName;
  InformationWedgit(String? keyN, String? valName) {
    this.keyN = keyN;
          ...
          Expanded(
              ...
              child: Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      color: Colors.white,
                      borderRadius: BorderRadius.circular(25)),
                  child: Center(child: Text(this.valName ?? '')))),
          Expanded(
              flex: 1,
              child: Container(
                  margin: EdgeInsets.symmetric(horizontal: 5),
                  ...
                  decoration: BoxDecoration(
                      ...
                      color: Colors.white,
                      borderRadius: BorderRadius.circular(25)),
                  child: Center(child: Text(this.keyN ?? ''))))
        ],
      ),
    );
  }
